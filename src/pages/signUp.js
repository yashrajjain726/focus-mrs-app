...
export default function TabsWrappedLabel() {
  ...
  return (
    <div style={{ overflowY: 'hidden'}}>
          <div
        style={{ padding: "0", height: "20vh", backgroundImage:'linear-gradient(180deg, #01ab98, #59b860)',display:'flex',alignItems:'center',justifyContent:'center'}}
      >
...
<div className="signup-title">
        <Typography align="left" style={{color:'#fff',fontWeight:'bold',fontSize:'30px'}}>
          ...
          <Typography align="left" style={{marginBottom:'5%',color:'#fff'}}>Sign In to continue
          </Typography>
        </div>
