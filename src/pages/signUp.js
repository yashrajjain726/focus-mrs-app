...
export default function TabsWrappedLabel() {
  ...
  return (
    ...
    <div style={{ padding: "0", height: "35vh",backgroundColor:'#bddbdb' }}>
        ...
        <img
          ...
          style={{ marginTop: "10vh",width:'10rem' }}

        ></img>
         <Typography align="left" style={{color:'#000',fontSize:'25px',fontWeight:'bold',marginTop:'2vh',marginLeft:'2%'}}>
            Hey, get on the board

        </Typography>
        <Typography align="left" style={{color:'#000',fontSize:'15px',fontWeight:'bold',marginLeft:'2%'}}>
            Sign up to continue

        </Typography></div>
      <div style={{height:'65vh',backgroundColor:'#bddbdb'}}>
          <  SignUpCard/>
          </div>
    </div>
  );
